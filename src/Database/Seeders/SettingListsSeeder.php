    ...
    public function run(): void
    {
        $settingLists = [
            ...
            [
                ...
                'label' => 'English',
                'value' => 'en',
                'metadata' => json_encode(['native_name' => 'English', 'flag' => 'gb']),
                'is_active' => true,
                'order' => 1,
            ],
            [
                ...
                'label' => 'Spanish',
                'value' => 'es',
                'metadata' => json_encode(['native_name' => 'Espanol', 'flag' => 'es']),
                'is_active' => true,
                'order' => 2,
            ],
            [
                ...
                'label' => 'French',
                'value' => 'fr',
                'metadata' => json_encode(['native_name' => 'Francais', 'flag' => 'fr']),
                'is_active' => true,
                'order' => 3,
            ],
            [
                ...
                'label' => 'German',
                'value' => 'de',
                'metadata' => json_encode(['native_name' => 'Deutsch', 'flag' => 'de']),
                'is_active' => true,
                'order' => 4,
            ],
