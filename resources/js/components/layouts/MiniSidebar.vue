  ...
  <aside class="mini-sidebar group">
    ...
    <div class="p-2 border-t border-white/10 group-hover:px-3 transition-all duration-300">
      ...
      >
        ...
        <span class="ml-3 overflow-hidden whitespace-nowrap opacity-0 w-0 transition-all duration-300 group-hover:opacity-100 group-hover:w-auto">{{ logoutLabel }}</span>
      </button>
    </div>
  </aside>
</template>
