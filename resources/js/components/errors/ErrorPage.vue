  ...
  <div class="card min-h-[60vh] flex items-center justify-center">
    <div class="text-center p-8 max-w-md mx-auto">
      ...
      <div class="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
        <!-- Primary Action -->
        <router-link v-if="primaryActionRoute" :to="primaryActionRoute" class="btn-primary inline-flex items-center">
          <Icon :name="primaryActionIcon" :size="20" class="mr-2" />
          {{ primaryActionText }}
        </router-link>
        <button v-else-if="primaryActionHandler" @click="primaryActionHandler" class="btn-primary inline-flex items-center">
          <Icon :name="primaryActionIcon" :size="20" class="mr-2" />
          {{ primaryActionText }}
        </button>
...
export default {
  ...
  emits: ['contact-support', 'retry', 'primary-action', 'secondary-action'],
  props: {
    errorCode: {
      type: [String, Number],
      default: '404',
