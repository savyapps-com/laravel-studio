...
// Register Blade language if enabled
function registerBladeLanguage(monaco) {
  if (!props.bladeSupport) return
...
async function initializeEditor() {
  try {
    ...
    editor = monaco.editor.create(editorContainer.value, {
      ...
      language: props.bladeSupport && props.language === 'blade' ? 'blade' : props.language,
